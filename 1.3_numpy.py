...
def test_run():
	print("\n" + "="*80)
	print("Script 1: Creating NumPy Arrays")
	print("="*80)
	# List to 1D array
...
def test_run():
	print("\n" + "="*80)
	print("Script 2: Generating Random Numbers")
	print("="*80)
...
def test_run():
	print("\n" + "="*80)
	print("Script 3: Array Attributes")
	print("="*80)
...
def test_run():
	print("\n" + "="*80)
	print("Script 4: Operations on Arrays")
	print("="*80)
...
def test_run():
	print("\n" + "="*80)
	print("Script 5: Locate Maximum Value")
	print("="*80)
...
def test_run():
	print("\n" + "="*80)
	print("Script 6: Using time function")
	print("="*80)
	t1 = time.time()
	print ("ML4T")
	t2 = time.time()
...
def test_run():
	...
	print("\n" + "="*80)
	print("Script 7: How Fast is Numpy?")
	print("="*80)
...
def test_run():
	print("\n" + "="*80)
	print("Script 8: Accessing Array Elements")
	print("="*80)
...
def test_run():
	print("\n" + "="*80)
	print("Script 9: Accessing Elements with Indices and Masking")
	print("="*80)
	a = np.random.rand(5)
...
def test_run():
	print("\n" + "="*80)
	print("Script 10: Arithmetic Operations")
	print("="*80)
